...
namespace MumboJumbo
{
    class StartMenuScreen
    {
        ...
        { 
            ...
            Texture2D nick1 = ct.Load<Texture2D>("Nick1");
            Texture2D nick2 = ct.Load<Texture2D>("Nick2");
            Texture2D nick3 = ct.Load<Texture2D>("Nick3");
            Texture2D score1 = ct.Load<Texture2D>("Score1");
            Texture2D score2 = ct.Load<Texture2D>("Score2");
            Texture2D score3 = ct.Load<Texture2D>("Score3");
            ...
            Exit = new Button(exit1, exit2, exit3, new Vector2(Load.position.X + 15, Load.position.Y + load1.Height * 2));
